...
from hummingbot.core.data_type.order_book_tracker_entry import KyberOrderBookTrackerEntry
    ...
    def data_source(self) -> OrderBookTrackerDataSource:
        if not self._data_source:
            if self._data_source_type is OrderBookTrackerDataSourceType.REMOTE_API:
                ...
                self._data_source = KyberAPIOrderBookDataSource(trading_pairs=self._trading_pairs)
            else:
